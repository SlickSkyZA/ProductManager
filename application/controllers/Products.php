...
class Products extends CI_Controller{
    ...
    public function __construct(){
        ...
        $this->load->model(['transaction', 'priority', 'productGroup', 'product']);
    }
    ...
    */
    ...
    public function add(){
        ...
        $this->form_validation->set_rules('productName', 'Product Name', ['required', 'trim', 'max_length[80]', 'is_unique[product.Name]'], //numeric
                ['required'=>"required"]);
        $this->form_validation->set_rules('productGroup', 'Product Group', ['required', 'trim', 'numeric'], ['required'=>"required"]);
        ...
        if($this->form_validation->run() !== FALSE){
             ...
             */
            $insertedId = $this->product->add(set_value('productName'), set_value('productGroup'), set_value('priority'), set_value('version'), set_value('description'));

            $itemName = set_value('productName');
