...
class Platforms extends CI_Controller{
    ...
    */
    ...
    public function add(){
        ...
        $this->form_validation->set_rules('platformName', 'Platform Name', ['required', 'trim', 'max_length[80]', 'is_unique[priority.Value]'], //numeric
                ['required'=>"required"]);
    ...
    */
    ...
    public function edit(){
        ...
        $this->form_validation->set_rules('itemName', 'Platform Name', ['required', 'trim',
