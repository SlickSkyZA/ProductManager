...
class Search extends CI_Controller{
    ...
    public function __construct() {
        ...
        'platform', 'company', 'productStatus', 'productTransaction', 'customerType',
    ...
    /**
     * [productGroupSearch description]
     * @return [type] [description]
     */
