...
class ProductTransactions extends CI_Controller{
    ...
    public function __construct(){
        ...
        $this->load->model(['productTransaction', 'priority', 'product', 'customer', 'platform', 'customerVender','productStatus']);
    }
    ...
    */
    ...
    public function add(){
        ...
        $this->form_validation->set_rules('itemProjectName', 'Project Name', ['trim']);
        ...
        if($this->form_validation->run() !== FALSE){
             ...
             */
            $insertedId = $this->productTransaction->add($product, $customer, $priority, $platform, $status, $competitor, $projectName, $description);

            //insert into eventlog
            //function header: addevent($event, $eventRowId, $eventDesc, $eventTable, $staffId)
            $desc = "New addition of product transaction:{$product}";
