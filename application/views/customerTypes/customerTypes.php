            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-2 form-inline form-group-sm">
                        <button class="btn btn-primary btn-sm" id='createItem'>Add New Type</button>
                    </div>
                    ...
                    <div class="col-sm-3 form-inline form-group-sm">
                        ...
                        <input type="search" id="itemSearch" class="form-control" placeholder="Search Type Name">
                    </div>
                </div>
            </div>
                    ...
                    <form name="addNewItemForm" id="addNewItemForm" role="form">
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group-sm">
                                <label for="itemName">Type Name</label>
                                <input type="text" id="itemName" name="itemName" placeholder="Type Name" maxlength="80"
                        ...
                        <div class="row text-center">
                            <div class="col-sm-6 form-group-sm">
                                <button class="btn btn-primary btn-sm" id="addNewItem">Add Type</button>
                            </div>
...
<!--end of modal--->
<script src="<?=base_url()?>public/js/customerTypes.js"></script>
