            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-2 form-inline form-group-sm">
                        <button class="btn btn-primary btn-sm" id='createItem'>Add New Status</button>
                    </div>
                    ...
                    <div class="col-sm-3 form-inline form-group-sm">
                        ...
                        <input type="search" id="itemSearch" class="form-control" placeholder="Search Status Name">
                    </div>
                </div>
            </div>
                    ...
                    <form name="addNewItemForm" id="addNewItemForm" role="form">
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group-sm">
                                ...
                                <input type="text" id="statusName" name="statusName" placeholder="Status Name" maxlength="80"
                                    class="form-control" onchange="checkField(this.value, 'statusNameErr')">
                                <span class="help-block errMsg" id="statusNameErr"></span>
                            </div>
                        </div>
                        ...
                        <div class="row text-center">
                            <div class="col-sm-6 form-group-sm">
                                <button class="btn btn-primary btn-sm" id="addNewItem">Add Status</button>
                            </div>
...
<!--end of modal--->
<script src="<?=base_url()?>public/js/productStatus.js"></script>
