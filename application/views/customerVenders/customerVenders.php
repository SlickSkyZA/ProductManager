            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-2 form-inline form-group-sm">
                        <button class="btn btn-primary btn-sm" id='createItem'>Add New Vender</button>
                    </div>
                    ...
                    <div class="col-sm-3 form-inline form-group-sm">
                        ...
                        <input type="search" id="itemSearch" class="form-control" placeholder="Search Vender Name">
                    </div>
                </div>
            </div>
                    ...
                    <form name="addNewItemForm" id="addNewItemForm" role="form">
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group-sm">
                                ...
                                <input type="text" id="venderName" name="venderName" placeholder="Vender Name" maxlength="80"
                                    class="form-control" onchange="checkField(this.value, 'venderNameErr')">
                                <span class="help-block errMsg" id="venderNameErr"></span>
                            </div>
                        </div>
                        ...
                        <div class="row text-center">
                            <div class="col-sm-6 form-group-sm">
                                <button class="btn btn-primary btn-sm" id="addNewItem">Add Vender</button>
                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="text-center">Edit Vender Name</h4>
                ...
                <form name="addNewItemForm" id="addNewItemForm" role="form">
                    <div class="row">
                        <div class="col-sm-4 form-group-sm">
                            <label for="itemNameEdit">Vender Name</label>
...
<!--end of modal--->
<script src="<?=base_url()?>public/js/customerVender.js"></script>
