...
if(is_cli()){
    ...
    $config['base_url'] =  $protocol.$host."/ProductManager/";
}

else if(stristr($host, "172.17.") !== FALSE){
    $config['base_url'] =  $protocol.$host."/ProductManager/";
}
    ...
    $config['base_url'] = in_array($host, $allowed) ? $protocol.$host."/ProductManager/" : "http://".$_SERVER['HTTP_HOST']."/";
}
