...
$(document).ready(function(){
    ...
    $("#addNewItem").click(function(e){
        ...
        var itemIssueType = $("#itemIssueType").val();
        var itemReportDate = $("#itemReportDate").val();
        var itemDesc = $("#itemDesc").val();

        if(!itemProduct || !itemCustomer || !itemPriority || !itemVersion || !itemIssueType || !itemReportDate){
            ...
            !itemIssueType ? $("#itemIssueTypeErr").text("required") : "";
